...
<form id="form_product" method="post">
    ...
    <div class="homePageSet">
        <ul>
            ...
            <li>
                <div class="textLabel">券后价</div>
                <div class="textInput"><input type="text" name="couponPrice" placeholder="请输入券后价（元）" value="${product.couponPrice}" /></div>
            </li>
            <li>
                <div class="textLabel">口令</div>
                <div class="textInput"><input type="text" name="watchword" placeholder="请输入口令" value="${product.watchword}"/></div>
            </li>
            <li>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code === 200) {
                    ...
                    setTimeout(function () {
                        window.location.href = '${contextPath}/app/advProductManage?type=5';
                    }, 1500);
                }
            }
        })
