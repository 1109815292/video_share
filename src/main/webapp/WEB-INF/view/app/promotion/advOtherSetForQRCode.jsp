...
<div class="advProduct-topWx">
    <form action="" id="uploadImg1" method="post" enctype="multipart/form-data">
        ...
        <div class="advPic-label">二维码图标</div>
    </form>
</div>
<div class="advProduct-topWx">
    <form action="" id="uploadImg2" method="post" enctype="multipart/form-data">
        ...
        <div class="advPic-label">二维码</div>
    </form>
</div>
...
<form id="form_other" method="post">
    <div class="homePageSet" style="float:left;border-top:1px solid #eee;">
        <ul>
            <li>
                <div class="textLabel">二维码名称</div>
                <div class="textInput"><input type="text" name="name" placeholder="请输入二维码名称" value="${other.name}"/></div>
            </li>
            <li>
                <div class="textLabel">二维码介绍</div>
                <div class="textInput"><textarea name="desc" placeholder="一句话介绍二维码" rows="3" cols="5">${other.desc}</textarea></div>
            </li>
        </ul>
    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code === 200) {
                    ...
                    setTimeout(function () {
                        window.location.href = '${contextPath}/app/advOtherManage?type=8';
                    }, 1500);
                }
            }
        })
