    ...
    <form class="layui-form" action="" method="post">
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="roleId" id="sel-role"  lay-search style="height: 38px;">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="menuId" id="sel-menu"  lay-search style="height: 38px;">
                    <option value="">选择菜单</option>
                    <c:forEach var="systemMenu" items="${systemMenuListList}">
                        <option value="${systemMenu.id}">${systemMenu.menuDesc}</option>
                    </c:forEach>
                </select>
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select name="isGrant" id="sel-isGrant"  lay-search style="height: 38px;">
...
<script>
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(add)', function(data){
            //发异步，把数据提交给后台
            $.post("${contextPath}/admin/sys/saveSysRolePermission",data.field,function(data){
                if(data == "success"){
