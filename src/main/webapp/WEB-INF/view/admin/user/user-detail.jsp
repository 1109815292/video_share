        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  name="pageName" disabled
                       autocomplete="off" class="layui-input" value="${userPage.pageName}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  name="companyName" disabled
                       autocomplete="off" class="layui-input" value="${userPage.companyName}">
            </div>
        </div>
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  name="name" disabled
                       autocomplete="off" class="layui-input" value="${userPage.name}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  name="mobile" disabled
                       autocomplete="off" class="layui-input" value="${userPage.mobile}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  name="wx" disabled
                       autocomplete="off" class="layui-input" value="${userPage.wx}">
            </div>
        </div>
        <div class="layui-form-item">
            ...
            <div class="layui-input-block">
                <input type="text"  name="sign" disabled
                       autocomplete="off" class="layui-input" value="${userPage.sign}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">个人微信二维码</label>
            <div class="layui-input-block">
                <input type="text"  name="wxQRCode" disabled
                       autocomplete="off" class="layui-input" value="${userPage.wxQRCode}">
            </div>
        </div>
        <div class="layui-form-item">
            <label class="layui-form-label">主页背景色</label>
            <div class="layui-input-block">
                <input type="text"  name="pageBackgroundColor" disabled
                       autocomplete="off" class="layui-input" value="${userPage.pageBackgroundColor}">
            </div>
        </div>
    </form>
