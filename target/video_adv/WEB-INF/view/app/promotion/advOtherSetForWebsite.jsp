...
<form id="form_other" method="post">
    <div class="homePageSet" style="float:left;border-top:1px solid #eee;">
        <ul>
            <li>
                <div class="textLabel">官网名称</div>
                <div class="textInput"><input type="text" name="name" placeholder="请输入官网名称" value="${other.name}"/></div>
            </li>
            <li>
                <div class="textLabel">官网链接</div>
                <div class="textInput"><input type="text" name="url" placeholder="请输入商品链接" value="${other.url}" /></div>
            </li>
            <li>
                <div class="textLabel">官网介绍</div>
                <div class="textInput"><textarea name="desc" placeholder="一句话介绍官网" rows="3" cols="5">${other.desc}</textarea></div>
            </li>
        </ul>
    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code === 200) {
                    ...
                    setTimeout(function () {
                        window.location.href = '${contextPath}/app/advOtherManage?type=6';
                    }, 1500);
                }
            }
        })
