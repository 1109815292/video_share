...
<div class="advProduct-topWx">
    <form action="" id="uploadImg1" method="post" enctype="multipart/form-data">
        <div class="advPic wxWidth">
            <label>
                <input style="position:absolute;opacity:0;width:90px;" accept="image/*" mutiple="mutiple"
        ...
        <div class="advPic-label">公众号头像</div>
    </form>
</div>
<div class="advProduct-topWx">
    <form action="" id="uploadImg2" method="post" enctype="multipart/form-data">
        ...
        <div class="advPic-label">公众号二维码</div>
    </form>
</div>
<form id="form_wx" method="post">
    <div class="homePageSet" style="float:left;border-top:1px solid #eee;">
        <ul style="padding-top:13px;">
            <li>
                <div class="textLabel">公众号名称</div>
                <div class="textInput"><input type="text" name="name" placeholder="请输入公众号名称" value="${other.name}"/></div>
            </li>
            <li>
                <div class="textLabel">公众号介绍</div>
                <div class="textInput"><textarea name="desc" placeholder="一句话介绍公众号" rows="3" cols="5">${other.desc}</textarea></div>
            </li>
        </ul>
    </div>
        ...
        $.ajax({
            ...
            success: function (data) {
                if (data.code === 200) {
                    ...
                    setTimeout(function () {
                        window.location.href = '${contextPath}/app/advOtherManage?type=1';
                    }, 1500);
                }
            }
        })
