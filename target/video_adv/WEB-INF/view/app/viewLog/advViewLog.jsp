...
<div class="videoViewLog-top">
    <div class="cont-block" style="width: 100%;">
        <div class="block-top" onclick="window.location.href='<%=path%>/app/video/play?type=myVideo&id=${advOther.id}'">
            <div class="top-coverImg img-square">
                <img src="${advOther.picUrl}" />
            </div>
            <div class="top-name">
                <div class="title">${advOther.name}</div>
                <div class="desc">${advOther.desc}</div>
            </div>
        </div>
        <div class="block-bottom">
            <ul>
                <li style="width:50%;"><div class="imgDiv"><img src="<%=path%>/statics/img/video/manage/bg_33.png" /></div><div class="textDiv">${advOther.viewCount}</div></li>
                <li style="width:50%;"><div class="imgDiv"><img src="<%=path%>/statics/img/video/manage/bg_34.png" /></div><div class="textDiv">${advOther.peopleCount}</div></li>
            </ul>
        </div>
    </div>
</div>
