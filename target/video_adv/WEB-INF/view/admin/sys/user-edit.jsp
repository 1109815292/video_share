...
<div class="x-body">
    <form class="layui-form" action="" method="post">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_email" name="fullName" required
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <input type="text" id="L_email" name="mobile" required
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="sel-role" name="roleId" class="valid">
        ...
        <div class="layui-form-item">
            ...
            <div class="layui-input-inline">
                <select id="sel-state" name="state" class="valid">
    ...
    <input type="hidden" id="inp-role" value="${user.roleId}" />
    <input type="hidden" id="inp-state" value="${user.state}" />
</div>
<script>
    $(function () {
    ...
    layui.use(['form','layer'], function(){
        ...
        form.on('submit(add)', function(data){
            //发异步，把数据提交给后台
            $.post("${contextPath}/admin/sys/sysUserSave",data.field,function(data){
                if(data == "success"){
